...
5. **Cada noticia muestra:** nombre/logo del medio (manejo de logos pendiente — pregunta
   11), titular como link directo a la noticia original en el sitio del medio, fecha de
   publicación, y extracto corto con la mención destacada (resaltado amarillo, como el
   boletín antiguo). *Regla de fecha propuesta: la declarada por el medio; si falta o no
   trae hora, la fecha de detección (ver pregunta 10).*
...
9. **Botón de descarga CSV** de las noticias visibles (pedido explícito del cliente;
...
5. **Repositorio público y reutilizable**: código abierto, documentado, con licencia
   permisiva (deseo explícito del cliente). Los logos de medios de terceros, si se usan,
   quedan fuera de esa licencia.
